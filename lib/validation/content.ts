...
export const siteSettingsSchema = z.object({
  ...
  work_heading: z.string().trim().max(300).optional().or(z.literal("")),
  capabilities_heading: z.string().trim().max(300).optional().or(z.literal("")),
  capabilities_subheading: z.string().trim().max(1000).optional().or(z.literal("")),
  process_heading: z.string().trim().max(300).optional().or(z.literal("")),
  process_subheading: z.string().trim().max(1000).optional().or(z.literal("")),
  contact_heading: z.string().trim().max(300).optional().or(z.literal("")),
  contact_subheading: z.string().trim().max(1000).optional().or(z.literal("")),
